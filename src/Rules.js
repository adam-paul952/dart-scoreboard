...
const X01Rules = () => {
  return (
    <div>
      <h1>X01:</h1>
      <p><b>Game Play:</b> X01 is a tournament style game, where players start with X01 points and lower their score to exactly 0.
      First players have to define how many points they start with (typically 301 or 501) be can be any number of points 
      the players want.
      </p>
      <p><b>Scoring:</b> This game can be played either by double-in and double-out or just double out. Player take turns throwing darts
...
const BaseBallRules = () => {
  return (
    <div>
      <h1>Baseball:</h1>
      <p><b>Game Play:</b> Players each take turns throwing three darts, starting with the 1. Once all players have thrown at the 1,
      ...
      <p><b>Scoring:</b> As players throw at the numbers 1 - 9, scoring works as a single is 1, a double is 2, and a treble is 3. Players 
      record their score, and whoever has the most points at the end of the game wins.
      </p>
      <p><b>Note:</b> As we play the game, there are a few exceptions. If a player successfully lands three darts in the number they
...
const CricketRules = () => {
  return (
    <div>
      <h1>Cricket:</h1>
      <p><b>Game Play:</b> Players take turns throwing three darts at the board, hitting the numbers 15 through
      ...
      <p><b>Scoring:</b> If a player hits a single, it accounts for 1 mark on a number, a double counts as 2, and
      ...
      <p><b>Note:</b> When it comes to the bulls-eye, a true bulls-eye is worth 2 of the 3 required marks for bull and a cow is 
...
const EliminationRules = () => {
  return (
    <div>
      <h1>Elimination:</h1>
      <p><b>Game Play:</b> Players alternate throwing 3 darts at the board trying to achieve the highest possible scoring hand. The next player
...
const KillerRules = () => {
  return(
    <div>
      <h1>Killer:</h1>
      <p><b>Game Play:</b> The game begins by players throwing darts into the board with their hand opposite for throwing. (If I was
      ...
      <p><b>Scoring:</b> Players take turns shooting at their assigned numbers (singles are 1, doubles are 2, trebles are 3), players gain
      ...
      <p><b>A few additional rules:</b> If a player has 4 lives and hits a double of their number, they in fact do not become a killer
